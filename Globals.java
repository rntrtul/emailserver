...
public class Globals {
    ...
    public static final int EMPTY_AVAILABLE_LIST = -60;
    ...
    public static int totalRecordsIndMessagesFile = 0;
    ...
    public static final int NET_SEND_ERROR = 0;
    public static final int NET_RECEIVE_ERROR = 0;
    ...
    public static final String SERVER_IP_ADDRESS = "10.206.137.23";
    public static String clientIPAddress = Globals.STR_NULL;
    public static String transmissionString = STR_NULL ; //concatenates all messages into one string
